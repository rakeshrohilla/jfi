  ...
  <!-- if logo is image enable this -->
    ...
    <div class="sidebar-menu-inner">
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        ...
        <li class="active"><a href="pricing"><i class="fa fa-table"></i> <span>Pricing tables</span></a></li>
              ...
              <div class="col-md-4 px-2">
                <div class="mb-4 price-card price-card1 p-lg-4 p-md-3 p-4">
                  ...
                  <div class="card-body p-0">
                    ...
                    <div class="mt-4">
                      <a href="signup" class="btn btn-lg btn-outline-primary btn-style border-btn">Sign up for
                        free</a>
                    </div>
                  </div>
                </div>
